<?php echo $this->Html->css(array('slider-pro.min','index','style'));
    echo $this->fetch('css');?>
  ...
  <p class="main_p">do travel, share it</p>
    ...
    <div class="sp-slides">
      ...
      <div class="sp-slide">
        ...
        <p class="sp-layer sp-white sp-padding"
          data-position="leftCenter" data-vertical="-50"
      ...
      <div class="sp-slide">
        ...
        <p class="sp-layer sp-black sp-padding"
          ...
          良質な旅行情報を <span class="hide-small-screen">まとめたwebサービスです。これから旅行に行く人は</span> <span class="hide-medium-screen">行き先への情報収集 すでに行かれた方には情報を共有して楽しんで下さい。</span>
        </p>
      </div>
    ...
    <div class="sp-thumbnails">
      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">アメリカ</div>
        <div class="sp-thumbnail-description">アメリカ本土から南アメリカ大陸</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">ヨーロッパ</div>
        <div class="sp-thumbnail-description">様々な文化を紹介しています。 イタリア フランス</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">東アジア</div>
        <div class="sp-thumbnail-description">中国・韓国・台湾</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">about us</div>
        <div class="sp-thumbnail-description">私たちのサービスについて</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">上海</div>
        <div class="sp-thumbnail-description">新たな風を感じに行きましょう。</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">東南アジア</div>
        <div class="sp-thumbnail-description">タイ/ベトナム/ミャンマー</div>
      </div>

      <div class="sp-thumbnail">
        <div class="sp-thumbnail-title">ロンドン</div>
