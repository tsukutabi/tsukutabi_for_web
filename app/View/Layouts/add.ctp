...
<script type="text/template" id="qq-template-manual-trigger">
        <div class="qq-uploader-selector qq-uploader" qq-drop-area-text="Drop files here">
            ...
            <ul class="qq-upload-list-selector qq-upload-list uk-list-striped" aria-live="polite" aria-relevant="additions removals" id="stripe jquery-ui-sortable">
                <li>
                    ...
                    <input type="text" class="text_" name="ImgComments[]" value="" placeholder="写真へのコメントを入れて下さい。">
